...
// Add CORS - You may want to allow only specific domains in production
var allowedOrigins = configuration.GetSection("AllowedOrigins").Get<string[]>() ?? new[] { "http://localhost:5000" };
